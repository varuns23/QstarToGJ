...
set M = 0 ## set 1 for MC
set D = 1 ## set 1 for Data
...
#foreach i (QstarToGJ_M_fhalf_1000  QstarToGJ_M_fhalf_1500  QstarToGJ_M_fhalf_2000  QstarToGJ_M_fhalf_2500  QstarToGJ_M_fhalf_3000  QstarToGJ_M_fhalf_3500 QstarToGJ_M_fhalf_4000 QstarToGJ_M_fhalf_4500)
#set XS  = (1.064                   0.105                   0.01484                 0.002425                4.304E-4                7.586E-5               1.258E-5               1.929E-6)
#set totalEvents = (60196.0         60053.0                 120012.0                120054.0                120059.0                160008.0               159808                 160000)
#setenv sourceDir /pnfs/cms/WAX/11/store/user/varun/2012/MC/Summer12/53X/QstarSignal/${i}/
#setenv InputFilesPath /pnfs/fnal.gov/usr/cms/WAX/11/store/user/varun/2012/MC/Summer12/53X/QstarSignal/${i}/
#setenv OutPath ${OutEos}/Signal
#set filesPerJob = 100
...
void PostAnalyzerData::Loop()
{
    ...
    //=================================================================================
    // Histograms for HLT turn ons
    //--------------for BARREL
    TH1F * h_HLT_Photon135_EB  = new TH1F("h_HLT_Photon135_EB","HLT_Photon135_EB",400,0.0,2000.0);
    h_HLT_Photon135_EB->GetYaxis()->SetTitle("Events/5 GeV");            h_HLT_Photon135_EB->GetYaxis()->CenterTitle();
    h_HLT_Photon135_EB->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");    h_HLT_Photon135_EB->GetXaxis()->CenterTitle();
    h_HLT_Photon135_EB->Sumw2();

    TH1F * h_HLT_Photon150_EB  = new TH1F("h_HLT_Photon150_EB","HLT_Photon150_EB",400,0.0,2000.0);
    h_HLT_Photon150_EB->GetYaxis()->SetTitle("Events/5 GeV");            h_HLT_Photon150_EB->GetYaxis()->CenterTitle();
    h_HLT_Photon150_EB->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");    h_HLT_Photon150_EB->GetXaxis()->CenterTitle();
    h_HLT_Photon150_EB->Sumw2();

    TH1F * h_HLT_Photon150_MassEB  = new TH1F("h_HLT_Photon150_MassEB","HLT_Photon150_MassEB",400,0.0,2000.0);
    h_HLT_Photon150_MassEB->GetYaxis()->SetTitle("Events/5 GeV");            h_HLT_Photon150_MassEB->GetYaxis()->CenterTitle();
    h_HLT_Photon150_MassEB->GetXaxis()->SetTitle("M_{#gamma+jet} (GeV)");    h_HLT_Photon150_MassEB->GetXaxis()->CenterTitle();
    h_HLT_Photon150_MassEB->Sumw2();

    TH1F * h_HLT_Photon90_EB_all  = new TH1F("h_HLT_Photon90_EB_all","HLT_Photon90_EB_all",400,0.0,2000.0);
    h_HLT_Photon90_EB_all->GetYaxis()->SetTitle("Events/5 GeV");            h_HLT_Photon90_EB_all->GetYaxis()->CenterTitle();
    h_HLT_Photon90_EB_all->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");    h_HLT_Photon90_EB_all->GetXaxis()->CenterTitle();
    h_HLT_Photon90_EB_all->Sumw2();

    TH1F * h_HLT_Photon90_MassEB  = new TH1F("h_HLT_Photon90_MassEB","HLT_Photon90_MassEB",400,0.0,2000.0);
    h_HLT_Photon90_MassEB->GetYaxis()->SetTitle("Events/5 GeV");            h_HLT_Photon90_MassEB->GetYaxis()->CenterTitle();
    h_HLT_Photon90_MassEB->GetXaxis()->SetTitle("M_{#gamma+jet} (GeV)");    h_HLT_Photon90_MassEB->GetXaxis()->CenterTitle();
    h_HLT_Photon90_MassEB->Sumw2();

    TH1F * h_HLT_Photon_EB  = new TH1F("h_HLT_Photon_EB","HLT_Photon_EB",400,0.0,2000.0);
    h_HLT_Photon_EB->GetYaxis()->SetTitle("Events/5 GeV");            h_HLT_Photon_EB->GetYaxis()->CenterTitle();
    h_HLT_Photon_EB->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");    h_HLT_Photon_EB->GetXaxis()->CenterTitle();
    h_HLT_Photon_EB->Sumw2();

    TH1F * h_HLT_Photon_MassEB  = new TH1F("h_HLT_Photon_MassEB","HLT_Photon_MassEB",400,0.0,2000.0);
    h_HLT_Photon_MassEB->GetYaxis()->SetTitle("Events/5 GeV");            h_HLT_Photon_MassEB->GetYaxis()->CenterTitle();
    h_HLT_Photon_MassEB->GetXaxis()->SetTitle("M_{#gamma+jet} (GeV)");    h_HLT_Photon_MassEB->GetXaxis()->CenterTitle();
    h_HLT_Photon_MassEB->Sumw2();
	...
	passHLT     = PassHLT(passedHLT135, passedHLT150, passed90HLTall, passedHLTall);
	...
	if(DATA){
		...
		if(fabs(Photon_sc_eta[PC]) < 1.4442 ){ 
		    if(passedHLT135)      h_HLT_Photon135_EB->Fill(Photon_pt[PC]);
		    if(passedHLT150){     h_HLT_Photon150_EB->Fill(Photon_pt[PC]);     h_HLT_Photon150_MassEB->Fill(getMass(PC,JC)); }
		    if(passed90HLTall){   h_HLT_Photon90_EB_all->Fill(Photon_pt[PC]);  h_HLT_Photon90_MassEB->Fill(getMass(PC,JC)); }
		    if(passedHLTall){     h_HLT_Photon_EB->Fill(Photon_pt[PC]);        h_HLT_Photon_MassEB->Fill(getMass(PC,JC)); }
		}
...
################################################################
##################PostAnalyzeData.h#####################
cat>PostAnalyzerData.h<<EOF
//////////////////////////////////////////////////////////
// This class has been automatically generated on
// Thu Oct  4 05:07:17 2012 by ROOT version 5.32/00
// from TTree myEvent/a tree with histograms
// found on file: dcap://cmsgridftp.fnal.gov:24125/pnfs/fnal.gov/usr/cms/WAX/11/store/user/varun/2012/Data/Run2012A_recover6Aug/AOD_Output_Run2012A_recover6Aug_10_1_0jb.root
//////////////////////////////////////////////////////////
...
class PostAnalyzerData {
	...
	virtual Bool_t   PassHLT(Bool_t &passedHLT135, Bool_t &passedHLT150, Bool_t &passed90HLTall, Bool_t &passedHLTall);
...
//    chain->Add("dcap://cmsgridftp.fnal.gov:24125/pnfs/fnal.gov/usr/cms/WAX/11/store/user/varun/2012/Data/Run2012A_recover6Aug/AOD_Output_Run2012A_recover6Aug_1_1_lKw.root");
     */
...
void PostAnalyzerData::BookHistos(){
	...
	h_mass_bin1[hi]      =new TH1F(name,"mass of photon+jet",6000,0.0,6000.0);
...
//----------------
// HLT for data
Bool_t PostAnalyzerData::PassHLT(Bool_t &passedHLT135, Bool_t &passedHLT150, Bool_t &passed90HLTall, Bool_t &passedHLTall){
    Bool_t passedHLT = false;
    Int_t HLTcounter = 0;
    const int SelectedTriggers = 20;
    ...
    //++++++++++++++++now doing the turn on part

    TString HLTPhotonRefTriggers[20]={ 
    ...
    // To make Turn on curves
    passedHLT135 = false;
    passedHLT150 = false;
    passed90HLTall = false;
    passedHLTall = false;


    for(Int_t p = 0; p < (*triggernames).size(); ++p){

	if( HLTPhotonRefTriggers[0] == ((*triggernames)[p]) || HLTPhotonRefTriggers[1] == ((*triggernames)[p]) || HLTPhotonTriggers[2] == ((*triggernames)[p]) || HLTPhotonRefTriggers[3] == ((*triggernames)[p]) || HLTPhotonRefTriggers[4] == ((*triggernames)[p]) || HLTPhotonRefTriggers[5] == ((*triggernames)[p]) || HLTPhotonRefTriggers[6] == ((*triggernames)[p]) || HLTPhotonRefTriggers[7] == ((*triggernames)[p]) || HLTPhotonRefTriggers[8] == ((*triggernames)[p]) || HLTPhotonRefTriggers[9] == ((*triggernames)[p]) || HLTPhotonTriggers[10] == ((*triggernames)[p]) || HLTPhotonRefTriggers[11] == ((*triggernames)[p]) || HLTPhotonRefTriggers[12] == ((*triggernames)[p]) || HLTPhotonRefTriggers[13] == ((*triggernames)[p]) || HLTPhotonRefTriggers[14] == ((*triggernames)[p]) || HLTPhotonRefTriggers[15] == ((*triggernames)[p]) || HLTPhotonRefTriggers[16] == ((*triggernames)[p]) || HLTPhotonRefTriggers[17] == ((*triggernames)[p]) || HLTPhotonRefTriggers[18] == ((*triggernames)[p]) || HLTPhotonRefTriggers[19] == ((*triggernames)[p]) ){

	    passed90HLTall = (*ifTriggerpassed)[p];
	}


	if(  HLTPhotonTriggers[0] == ((*triggernames)[p]) || HLTPhotonTriggers[1] == ((*triggernames)[p]) || HLTPhotonTriggers[2] == ((*triggernames)[p]) || HLTPhotonTriggers[3] == ((*triggernames)[p]) || HLTPhotonTriggers[4] == ((*triggernames)[p]) || HLTPhotonTriggers[5] == ((*triggernames)[p]) || HLTPhotonTriggers[6] == ((*triggernames)[p]) || HLTPhotonTriggers[7] == ((*triggernames)[p]) || HLTPhotonTriggers[8] == ((*triggernames)[p]) || HLTPhotonTriggers[9] == ((*triggernames)[p]) ){

	    if( (*triggerprescales)[p] == 1 && passed90HLTall ){
		passedHLT135 = (*ifTriggerpassed)[p];
	    }
	}


	if( HLTPhotonTriggers[10] == ((*triggernames)[p]) || HLTPhotonTriggers[11] == ((*triggernames)[p]) || HLTPhotonTriggers[12] == ((*triggernames)[p]) || HLTPhotonTriggers[13] == ((*triggernames)[p]) || HLTPhotonTriggers[14] == ((*triggernames)[p]) || HLTPhotonTriggers[15] == ((*triggernames)[p]) || HLTPhotonTriggers[16] == ((*triggernames)[p]) || HLTPhotonTriggers[17] == ((*triggernames)[p]) || HLTPhotonTriggers[18] == ((*triggernames)[p]) || HLTPhotonTriggers[19] == ((*triggernames)[p]) ){

	    if( (*triggerprescales)[p] == 1 && passed90HLTall ){
		passedHLT150 = (*ifTriggerpassed)[p];
	    }
	}


	if( HLTPhotonTriggers[0] == ((*triggernames)[p]) || HLTPhotonTriggers[1] == ((*triggernames)[p]) || HLTPhotonTriggers[2] == ((*triggernames)[p]) || HLTPhotonTriggers[3] == ((*triggernames)[p]) || HLTPhotonTriggers[4] == ((*triggernames)[p]) || HLTPhotonTriggers[5] == ((*triggernames)[p]) || HLTPhotonTriggers[6] == ((*triggernames)[p]) || HLTPhotonTriggers[7] == ((*triggernames)[p]) || HLTPhotonTriggers[8] == ((*triggernames)[p]) || HLTPhotonTriggers[9] == ((*triggernames)[p]) || HLTPhotonTriggers[10] == ((*triggernames)[p]) || HLTPhotonTriggers[11] == ((*triggernames)[p]) || HLTPhotonTriggers[12] == ((*triggernames)[p]) || HLTPhotonTriggers[13] == ((*triggernames)[p]) || HLTPhotonTriggers[14] == ((*triggernames)[p]) || HLTPhotonTriggers[15] == ((*triggernames)[p]) || HLTPhotonTriggers[16] == ((*triggernames)[p]) || HLTPhotonTriggers[17] == ((*triggernames)[p]) || HLTPhotonTriggers[18] == ((*triggernames)[p]) || HLTPhotonTriggers[19] == ((*triggernames)[p]) ){

	    if( (*triggerprescales)[p] == 1 && passed90HLTall ){
		passedHLTall   = (*ifTriggerpassed)[p]; 
	    }
	}
...
rm PostAnalyzerData.C
rm PostAnalyzerData.h 
