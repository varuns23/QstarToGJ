...
Int_t main(){
  ...
  prefix = "ptPhotJet190etaJet2p4dPhi2p5dEta2p0M560LID"; // for Input root Files and also for output files (if any)
  ...
  draw1DHistos(Inputfiles, "dphi_MassCut", 2.45, 3.2, 0.01, 1e5, "bottomCenter", true, 0);

  draw1DHistos(Inputfiles, "Photon_SigmaIetaIeta_MassCut", 0.0, 0.018, 0.01, 2e4, "topRight", false, 0);
