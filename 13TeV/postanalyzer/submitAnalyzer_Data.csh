...
foreach i ( Run2015D_PromptReco_v3  Run2015D_PromptReco_v4)
set XS =  ( 1.                      1. )
set totEvnts = (1                   1)
setenv sourceDir /eos/uscms/store/user/lpcqstar/13TeV/NTuples/DATA/${i}/
...
foreach i ( Run2015D_PromptReco_v3)
set XS =  ( 1.                    )
set totEvnts = (1                 )
setenv sourceDir /eos/uscms/store/user/lpcqstar/13TeV/NTuples/DATA/${i}/
setenv OutPath ${OutEos}/Data_TEST
set filesPerJob = 1000 ## Total files : max
endif
##
###----------------------------------------------------------------------------------------------------
...
void PhoJet_Analyzer_Data::Loop()
{
  ...
  HLT_Photon.push_back(HLT_Photon300_NoHE);
  HLT_Photon.push_back(HLT_Photon500);
  HLT_Photon.push_back(HLT_Photon600);
...
//  Long64_t nentries = fChain->GetEntriesFast();
  ...
  for(int ijet=0; ijet<nJet; ++ijet)
    if( foundTrigPhoton.size() > 0 && jetID(ijet) && fabs(jetEta->at(ijet)) < cut_jetEta)
...
// Tue Oct 20 08:56:00 2015 by ROOT version 6.02/05
// from TTree EventTree/Event data
// found on file: /eos/uscms/store/user/lpcqstar/13TeV/NTuples/DATA/Run2015D_PromptReco_v3/ggNtuples_25ns_data_27.root
//////////////////////////////////////////////////////////
...
void PhoJet_Analyzer_Data::BookHistos(){
  ...
  h_phoHT      = new TH1F ("h_phoHT","Sum et of all pho in event ", 20, 0.0, 4000.);
  h_phoHT->GetXaxis()->SetTitle("Sum et of all pho in event");
  h_firstphoPt  = new TH1F ("h_firstphoPt","pt of leading pho in event ", 20, 0.0, 4000.);
...
Bool_t PhoJet_Analyzer_Data::jetID(Int_t ijet){
...
// AK8 Jet ID
// https://twiki.cern.ch/twiki/bin/viewauth/CMS/JetID#Recommendations_for_13_TeV_data
Bool_t PhoJet_Analyzer_Data::AK8jetID(Int_t ijet){
